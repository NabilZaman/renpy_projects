...
label day7_morning_take2(callback):
...
label day7_afternoon_take2(callback):
...
label day7_night_take2(callback):
...
init python:
    plot_schedule.schedule_event((7, TOD.MORNING), Event("day7_morning"))
    plot_schedule.schedule_event((7, TOD.AFTERNOON), Event("day7_afternoon"))
    plot_schedule.schedule_event((7, TOD.NIGHT), Event("day7_night", takes_time=False))
    plot_schedule.schedule_event((7, TOD.MORNING), Event("day7_morning_take2"))
    plot_schedule.schedule_event((7, TOD.AFTERNOON), Event("day7_afternoon_take2"))
    plot_schedule.schedule_event((7, TOD.NIGHT), Event("day7_afternoon_night2"))
